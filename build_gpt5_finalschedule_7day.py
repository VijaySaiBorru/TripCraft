...
for idx, row in df.iterrows():
    try:
        ...
        events_city_3 = safe_json(row.get("events_city_3_response")) or {}

        city_1 = str(row.get("city_1", "")).strip()
        city_2 = str(row.get("city_2", "")).strip()
        city_3 = str(row.get("city_3", "")).strip()
        ...
        poi_map = {
            ...
            6: str(row.get("day6_itinerary_formatted", "")),
            7: str(row.get("day7_itinerary_formatted", "")),
        }
        ...
        for i, day in enumerate(schedule):
            ...
            # 🔥 CITY DISTRIBUTION (IMPORTANT LOGIC)
            if day_num <= 3:
                city = city_1
...
print("✅ Done. 7-day schedule enriched successfully.")
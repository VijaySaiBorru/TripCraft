    ...
    def build_prompt(self, attraction_ref, persona, trip_json, local_constraints):
        ...
        for a in attraction_ref:
            card = {
                ...
                "attraction_quality": a.get("attraction_quality"),
                "experience_signal": a.get("experience_signal"),
                "nature_signal": a.get("nature_signal"),
                "culture_signal": a.get("culture_signal"),
                "family_signal": a.get("family_signal"),
                "facility_signal": a.get("facility_signal"),
                "persona_alignment": a.get("persona_alignment"),
                "persona_utility": a.get("persona_utility"),

                "crowd_risk": a.get("crowd_risk"),
                "safety_risk": a.get("safety_risk"),
...
- Review-based quality signals (attraction_quality, experience_signal, nature_signal, culture_signal, family_signal, facility_signal).
- Risk signals (crowd_risk, safety_risk) — lower is better.
...
When in doubt between two attractions:
- Prefer higher persona_alignment and persona_utility.
- If similar on persona fit, prefer higher attraction_quality / experience_signal.
- If still similar, prefer lower crowd_risk and safety_risk.

    ...
    def _build_poi_list_for_day(self, day, day_index, days, cities):
       ...
       # ===================== ATTRACTION DURATION (FINAL) =====================
        ...
        def handle_last_day():
            ...
            # 🔥 HARD SAFETY: enforce buffer AFTER lunch
            ln_latest_safe = dep_abs - BUFFER - LUNCH_DUR

            ln_end_limit = min(LUNCH_WIN[1] + 24 * 60, ln_latest_safe)
            ...
            if ln_earliest + LUNCH_DUR <= ln_end_limit:
                ...
                if effective_ln_start + LUNCH_DUR <= ln_latest_safe:
                    add(day.get("lunch"), ln_start, LUNCH_DUR, True, "lunch")
